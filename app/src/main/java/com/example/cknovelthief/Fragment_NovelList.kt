...
class Fragment_NovelList : StatedFragment() {
    ...
    fun reloadSetting() {
        getActivity()!!.runOnUiThread {
            var sharePreferenceProfile_Local = this.getActivity()!!.getSharedPreferences("LocalProfileSetting", Context.MODE_PRIVATE)
...
//                this.context.startActivity(intentNovelLink)
            ...
            vh.ll_item.setOnLongClickListener {
                ...
                bundle.putInt("PageDialogType", 0)
                ...
                (mContext as MainActivity).startActivityForResult(intentGetDialog, Global.LIST_REQUEST_NEXT)
                true
            }
        }
        ...
        inner class novelViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            fun loadingSettingValue() {
                var sharePreferenceProfile_Local = context.getSharedPreferences("LocalProfileSetting", Context.MODE_PRIVATE)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
            if (resultCode == Global.LIST_RESULT_NEXT && requestCode==Global.LIST_REQUEST_NEXT) {
